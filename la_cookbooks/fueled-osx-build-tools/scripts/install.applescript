on run argv
	tell application "Safari"
		...
		set apple_id to the text returned of (display dialog "Please enter your apple id email:" with title "Apple ID" default answer "" buttons {"OK"} default button 1)
		set apple_password to the text returned of (display dialog "Please enter your apple id password:" with title "Password" with icon caution default answer "" buttons {"OK"} default button 1 with hidden answer)
      ...
      function fillInForm(){
        ...
        if(jQuery('#accountname').length > 0){
     	 ...
     	 //hide and change the field type to avoid password saving prompt
